...
MIDDLEWARE = [
    ...
    "OmniDB_app.middleware.QueryTokenSessionMiddleware",
...
ASGI_APPLICATION = "OmniDB.asgi.application"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "console_django": {"class": "logging.StreamHandler", "formatter": "standard"},
        "console_omnidb_app": {
