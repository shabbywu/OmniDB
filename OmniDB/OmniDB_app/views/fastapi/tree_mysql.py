...
@app.post("/get_fks_columns_mysql/")
def get_fks_columns(
    user=Depends(dependencies.get_user),
    json_object=Depends(dependencies.parse_json_object),
    v_session=Depends(dependencies.get_omnidb_session),
...
@app.post("/get_uniques_columns_mysql/")
...
@app.post("/get_indexes_columns_mysql/")
...
@app.post("/get_function_fields_mysql/")
...
@app.post("/get_function_definition_mysql/")
...
@app.post("/get_procedure_fields_mysql/")
...
@app.post("/get_procedure_definition_mysql/")
...
@app.post("/get_views_columns_mysql/")
...
@app.post("/get_view_definition_mysql/")
...
@app.post("/template_select_mysql/")
def template_select(
    user=Depends(dependencies.get_user),
    json_object=Depends(dependencies.parse_json_object),
    v_session=Depends(dependencies.get_omnidb_session),
...
@app.post("/template_insert_mysql/")
def template_insert(
    user=Depends(dependencies.get_user),
    json_object=Depends(dependencies.parse_json_object),
    v_session=Depends(dependencies.get_omnidb_session),
...
@app.post("/template_update_mysql/")
def template_update(
    user=Depends(dependencies.get_user),
    json_object=Depends(dependencies.parse_json_object),
    v_session=Depends(dependencies.get_omnidb_session),
